...
import { Boxes, FolderKanban, Layers3, LogOut, ShieldHalf, ShoppingCart, X, MessageSquare, Palette } from 'lucide-react';

export type DashboardSection = 'models' | 'catalogue' | 'configs' | 'orders' | 'avis' | 'samples' | 'password';

...
import { Boxes, FolderKanban, Layers3, LogOut, ShieldHalf, X, MessageSquare } from 'lucide-react';

export type DashboardSection = 'models' | 'catalogue' | 'configs' | 'avis' | 'password';

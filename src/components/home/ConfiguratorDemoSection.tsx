        ...
        <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 lg:pr-8">
              ...
              <h2
                  data-animate
                  className="mt-8 text-[clamp(2.5rem,6vw,4.5rem)] font-black leading-[0.95] tracking-[-0.03em] text-white opacity-0 translate-y-4 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 transition-all duration-700"
              >
                Votre meuble.
                <br />
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-[#8B7355] translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                  <span className="absolute inset-0 flex items-center justify-center gap-3 text-white translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                ...
                <Link
                    href="#demo"
                    className="inline-flex items-center gap-2 px-6 py-4 text-sm font-medium text-white/70 hover:text-white transition-colors"
                >
              ...
              <div
                  data-animate
                  className="mt-12 flex items-center gap-8 opacity-0 translate-y-4 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 transition-all duration-700"
              >
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-black text-[#8B7355]">3D</span>
                ...
                <div className="w-px h-6 bg-white/10" />
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-black text-[#8B7355]">∞</span>
                  <span className="text-xs text-[#706F6C] uppercase tracking-wider">
                  Options
                </span>
                </div>
            ...
            <div className="lg:col-span-7 relative">
              {/* Floating element - Top Left: Visualisation */}
              <div
                  data-animate
                  className="absolute -top-4 -left-4 lg:-top-8 lg:-left-8 z-20 opacity-0 translate-y-4 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 transition-all duration-700"
              >
              ...
              {/* Floating element - Bottom Right: Devis Instantané */}
              <div
                  data-animate
                  className="absolute -bottom-4 -right-4 lg:-bottom-6 lg:-right-6 z-20 opacity-0 translate-y-4 [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 transition-all duration-700 delay-200"
              >
